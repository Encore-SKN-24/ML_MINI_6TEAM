...
movie_df = pd.read_csv('././data/movies_processed_final.csv')
music_df = pd.read_csv('././data/music_list.csv')
...
movie_df.to_csv('././data/movies_processed_final.csv', index=False)
